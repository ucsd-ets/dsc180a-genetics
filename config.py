...
path_fastqc   = "/opt/FastQC/fastqc" #aut
path_kallisto = "/opt/kallisto_linux-v0.42.4/kallisto" #aut
path_star     = "/opt/STAR_2.5.2b/bin/Linux_x86_64_static/STAR"
path_htseq    = "/opt/conda/bin/htseq-count" # no
path_picard   = "/opt/picard-tools-1.88" #aut
path_samtools = "/opt/samtools-1.10/samtools" #aut
path_varscan  = "/opt/varscan/VarScan.v2.3.6.jar" #aut
path_gtf2gp   = "/opt/gtfToGenePred/gtfToGenePred" #aut
path_gatk     = "/opt/GATK-3.5/GenomeAnalysisTK.jar" # no
path_cutadapt = "/opt/python2.7/bin/cutadapt" # no
path_trimgalore = "/gpfs/gpfs1/myerslab/reference/genomes/rnaseq_pipeline/bin/trim_galore" # aut
path_starfusion = "/opt/STAR_2.5.2b/STAR-Fusion/STAR-Fusion"
path_jsplice = "/opt/jSplice-1.0.1/" #aut
...
environment = {"JAVA_HOME":      ["/usr/java/jdk1.8.0_60/","add"],
               "PYTHONPATH":     ["/opt/HTSeq-0.5.3/lib/python","overwrite"],
               "PATH":           ["/opt/Python-2.7.2/bin","add"],
               "PATH":           ["/opt/bedtools2-2.20.0/bin","add"],
               "PATH":           ["/opt/samtools-1.2/bin","add"],
               "LD_LIBRARY_PATH":["/opt/gcc-4.8.2/usr/lib64","add"],
               "PERL5LIB"       :["/opt/perl-modules/lib/perl5/5.10.1:/opt/perl-modules/lib/perl5/5.10.1/lib64/perl5","add"]}
